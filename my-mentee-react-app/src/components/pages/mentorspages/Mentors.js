...
// ── CHANGED: ReviewForm now validates name to letters and spaces only ──
function ReviewForm({ onAddReview }) {
  const [reviewerName, setReviewerName] = useState("");
  const [message, setMessage] = useState("");
  const [nameError, setNameError] = useState("");

  // ── CHANGED: only allows letters and spaces in the name field ──
  ...
  return (
    <form onSubmit={handleSubmit}
      ...
      {/* ── CHANGED: name input now has letter-only validation ── */}
