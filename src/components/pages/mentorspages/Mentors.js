...
// ── CHANGED: empty array — new user has no mentors yet ──
...
// ── CHANGED: uses mentorsemptystate.svg from public folder ──
...
// ── CHANGED: shows empty state when no mentors, no ?mode=empty needed ──
if (mentors.length === 0) {
