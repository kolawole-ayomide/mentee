...
const mentorBaseData = [
  {
    ...
    linkedin: "#",
    bio: "Daniel Francis is a dynamic marketing leader with a passion for driving brand excellence. She has successfully spearheaded numerous marketing campaigns for global brands and played a pivotal role in enhancing their market presence.",
    experience: "Over 15 years of experience in marketing strategy and brand management.",
    areas: ["Brand Strategy", "Market Research"],
    mentorshipApproach: "Daniel believes in a collaborative mentoring approach. He adapts his style to cater to the unique needs of each mentee, fostering creativity and strategic thinking.",
  },
  {
    ...
    email: "danielfrancis20@gmail.com",
    linkedin: "#",
    bio: "Daniel Francis is a dynamic marketing leader with a passion for driving brand excellence.",
    experience: "Over 15 years of experience in marketing strategy and brand management.",
    areas: ["Brand Strategy", "Market Research"],
    mentorshipApproach: "Daniel believes in a collaborative mentoring approach.",
  },
  {
    id: "mentor-3", name: "Daniel Francis", role: "Head of marketing", expertise: "Skill Development",
    category: "Personal Development", image: "/daniel.png", detailImage: "/daniel.png", available: true,
    email: "danielfrancis20@gmail.com", linkedin: "#", bio: "Experienced mentor focused on career clarity and growth.",
    experience: "10+ years of leadership and brand experience.", areas: ["Leadership", "Communication"],
    mentorshipApproach: "Supportive and practical mentoring style.",
  },
  {
    id: "mentor-4", name: "Daniel Francis", role: "Head of marketing", expertise: "Skill Development",
    category: "Career Development", image: "/boss.png", detailImage: "/boss.png", available: true,
    email: "danielfrancis20@gmail.com", linkedin: "#", bio: "Strong background in marketing strategy and positioning.",
    experience: "12+ years of strategy and market development.", areas: ["Growth", "Planning"],
    mentorshipApproach: "Structured mentoring with clear milestones.",
  },
  {
    id: "mentor-5", name: "Daniel Francis", role: "Head of marketing", expertise: "Skill Development",
    category: "Professional Development", image: "/boss.png", detailImage: "/boss.png", available: true,
    email: "danielfrancis20@gmail.com", linkedin: "#", bio: "Experienced in mentoring early career professionals.",
    experience: "14+ years across marketing and business development.", areas: ["Market Research", "Execution"],
    mentorshipApproach: "Practical sessions focused on real-world outcomes.",
  },
  {
    id: "mentor-6", name: "Daniel Francis", role: "Head of marketing", expertise: "Skill Development",
    category: "Recommended Mentors", image: "/daniel.png", detailImage: "/daniel.png", available: false,
    email: "danielfrancis20@gmail.com", linkedin: "#", bio: "Focused on helping mentees develop communication and leadership.",
    experience: "8+ years of mentoring and team leadership.", areas: ["Leadership", "Strategy"],
    mentorshipApproach: "Encouraging, reflective, and tailored to the mentee's pace.",
  },
  {
    id: "mentor-7", name: "Daniel Francis", role: "Head of marketing", expertise: "Skill Development",
    category: "Skill Development", image: "/daniel.png", detailImage: "/daniel.png", available: true,
    email: "danielfrancis20@gmail.com", linkedin: "#", bio: "Supports mentees with strategic planning and communication.",
    experience: "11+ years in brand and product marketing.", areas: ["Brand Strategy", "Storytelling"],
    mentorshipApproach: "Blends accountability with supportive guidance.",
  },
  {
    id: "mentor-8", name: "Daniel Francis", role: "Head of marketing", expertise: "Skill Development",
    category: "Personal Development", image: "/daniel.png", detailImage: "/daniel.png", available: false,
    email: "danielfrancis20@gmail.com", linkedin: "#", bio: "Supports mentees who want clarity and confidence in their path.",
    experience: "9+ years in coaching and communication growth.", areas: ["Career Growth", "Confidence"],
    mentorshipApproach: "Gentle but focused style that helps mentees take action.",
  },
];

const initialReviewsByMentor = {
  "daniel-francis": [
    { id: 1, name: "Anonymous", role: "Mentee", message: "Jane's mentoring has been instrumental in my career growth. Her insights and guidance have helped me achieve my marketing goals.", date: "13 August, 2023" },
    { id: 2, name: "Juliana Abel", role: "Mentee", message: "Jane's mentoring has been instrumental in my career growth. Her insights and guidance have helped me achieve my marketing goals.", date: "13 August, 2023" },
    { id: 3, name: "Juliana Abel", role: "Mentee", message: "Jane's mentoring has been instrumental in my career growth. Her insights and guidance have helped me achieve my marketing goals.", date: "13 August, 2023" },
  ],
  "daniel-no-reviews": [], "mentor-3": [], "mentor-4": [],
...
function MentorCard({ mentor, isRequested, onToggleRequest }) {
  return (
    <article
      onClick={() => { if (mentor.available) onToggleRequest(mentor.id); }}
      className={cx(
        "rounded-2xl border bg-white p-3 transition cursor-pointer",
        isRequested ? "border-rose-400 shadow-sm" : "border-slate-200 hover:border-slate-300",
        !mentor.available && "opacity-70 cursor-not-allowed"
      )}
    >
      <div className="relative overflow-hidden rounded-xl">
        <MentorImage mentor={mentor} srcOverride={mentor.image} className="h-28 w-full" />
        {!mentor.available && (
          <div className="absolute inset-0 flex items-center justify-center bg-slate-900/30">
            <span className="text-sm font-medium tracking-wide text-white">[ Unavailable ]</span>
          </div>
        )}
      </div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        ...
        <button
          type="button"
          onClick={(e) => { e.stopPropagation(); if (mentor.available) onToggleRequest(mentor.id); }}
          disabled={!mentor.available}
          className={cx(
            "inline-flex items-center justify-center rounded-md px-2 py-2 text-[11px] font-semibold transition",
            mentor.available ? "bg-rose-600 text-white hover:bg-rose-700" : "cursor-not-allowed bg-slate-200 text-slate-400"
          )}
        >
...
function BrowseView({ mentors, requestedMentorIds, onToggleRequest, search, setSearch, activeTab, setActiveTab }) {
  const filteredMentors = useMemo(() => {
    return mentors.filter((mentor) => {
      const matchesTab = activeTab === "All" || mentor.category === activeTab || mentor.expertise === activeTab;
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-xs text-slate-500 sm:text-sm">Your Journey, Your Choice: Discover Your Mentors</p>
        </div>
      ...
      {filteredMentors.length === 0 ? (
        <div className="flex min-h-[300px] flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-6 text-center">
          ...
          <p className="mt-3 text-sm font-medium text-slate-900">No mentors found</p>
          <p className="mt-1 text-xs text-slate-500">Try another keyword or switch category.</p>
        </div>
      ) : (
...
function DetailSection({ title, children, accent = "" }) {
  return (
    <section className="space-y-2">
      ...
      {accent ? (
        <div className="border-l-2 border-l-amber-400 pl-3 text-sm text-slate-500">{children}</div>
      ) : (
...
function DetailView({ mentor, reviewCount, reviews, isRequested, onToggleRequest, onAddReview }) {
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.6fr)_320px] xl:divide-x xl:divide-slate-200">
        <div className="space-y-6 xl:pr-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
            <MentorImage mentor={mentor} srcOverride={mentor.detailImage}
              className="h-24 w-24 shrink-0 rounded-full border border-slate-200 shadow-sm" rounded="rounded-full" />
            <div className="min-w-0">
              ...
              <div className="mt-2 space-y-1 text-xs text-slate-600">
                <p className="flex flex-wrap items-center gap-2">
                  ...
                  <span>Email:</span>
                  <a href={`mailto:${mentor.email}`} className="text-[#312F61] underline">{mentor.email}</a>
                </p>
                <p className="flex flex-wrap items-center gap-2">
                  <FiLink2 className="h-3.5 w-3.5 text-slate-400" />
                  <span>LinkedIn:</span>
                  <a href={mentor.linkedin} className="text-[#312F61] underline" target="_blank" rel="noreferrer">My profile</a>
                </p>
              </div>
          ...
          <section className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {mentor.areas.map((area) => (
                <span key={area} className="rounded-md bg-rose-50 px-3 py-2 text-[11px] font-medium text-rose-600">{area}</span>
              ))}
            </div>
          </section>

          <DetailSection title="Mentorship Approach" accent="amber">{mentor.mentorshipApproach}</DetailSection>

          <section className="space-y-3">
            <div className="border-l-2 border-l-rose-500 pl-3">
              <h3 className="text-sm font-semibold text-slate-900">Connect with {mentor.name.split(" ")[0]}</h3>
            ...
            <button type="button" onClick={() => onToggleRequest(mentor.id)} disabled={!mentor.available}
              className={cx(
        ...
        <aside className="space-y-4 xl:pl-8">
          <h2 className="text-sm font-semibold text-slate-900">Reviews ({reviewCount})</h2>
...
export default function Mentors() {
  ...
  const selectedMentor = useMemo(() => {
    ...
    return mentorBaseData.find((mentor) => mentor.id === mentorId) || null;
  }, [mentorId]);
  ...
  if (mentorBaseData.length === 0) {
    return (
      <div className="space-y-6">
        <h1 className="text-2xl font-semibold text-slate-900">Mentors</h1>
        <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
          <img src="/mentorsemptystate.svg" alt="No mentors" className="h-40 w-auto object-contain sm:h-48"
          ...
          <p className="mt-2 max-w-md text-xs leading-6 text-slate-500 sm:text-sm">
            It looks like there are no mentors available at the moment.
          </p>
        </div>
      </div>
    );
...
export { MentorCard, mentorBaseData };
...
// // ✅ mentor data restored from first file — empty state shows only when this is empty
// const mentorBaseData = [
//   {
//     id: "daniel-francis",
//     name: "Daniel Francis",
...
// // ✅ reviews restored from first file
// const initialReviewsByMentor = {
//   "daniel-francis": [
//     {
//       id: 1,
...
// function MentorImage({ mentor, className = "", rounded = "rounded-xl", srcOverride = "" }) {
...
//           onClick={(e) => {
//             e.stopPropagation();
//             if (mentor.available) onToggleRequest(mentor.id);
//           }}
//           disabled={!mentor.available}
//           className={cx(
//             "inline-flex items-center justify-center rounded-md px-2 py-2 text-[11px] font-semibold transition",
...
//         <FiStar
//           key={value}
//           className={cx("h-3.5 w-3.5", value <= Math.round(safeCount) ? "fill-current" : "")}
//         />
//       ))}
...
//                   <FiMail className="h-3.5 w-3.5 text-slate-400" />
//                   <span>Email:</span>
//                   <a href={`mailto:${mentor.email}`} className="text-[#312F61] underline">
//                     {mentor.email}
//                   </a>
//                 </p>
//                 <p className="flex flex-wrap items-center gap-2">
//                   <FiLink2 className="h-3.5 w-3.5 text-slate-400" />
//                   <span>LinkedIn:</span>
//                   <a href={mentor.linkedin} className="text-[#312F61] underline"
...
//               </h3>
//               <p className="mt-2 text-sm leading-7 text-slate-500">
//                 Ready to learn from {mentor.name.split(" ")[0]}'s extensive marketing experience?
//                 Click the button below to connect and kickstart your mentoring journey.
//               </p>
//             </div>
//             <button
//               type="button"
...
//   // empty state only when mentorBaseData is truly empty
//   if (mentors.length === 0) {
