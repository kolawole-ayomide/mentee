// src/components/pages/profile/Security.js
...
// ── CHANGED: reads localStorage inside a function instead of at the top level ──
// ── Same lazy initialiser pattern used in PersonalInfo.js and UserContext.js ──
...
export default function Security() {
  // ── CHANGED: was `const storedUser = JSON.parse(...)` outside the component ──
  // ── That ran once at import time and never updated ──
  // ── Now uses lazy initialiser so it reads localStorage on first render ──
  ...
  const handleSave = () => {
    ...
    // ── Save new password back to localStorage ──
    try {
