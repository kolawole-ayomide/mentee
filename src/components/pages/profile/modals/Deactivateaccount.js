...
// close modal then redirect to signup
onClose();
navigate("/Chosen");
};
...
<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
    ...
    <div className="flex items-center justify-between">
        <h3 className="font-bold text-base" style={{ color: C.dark }}>Deactivate Account</h3>
    ...
    <div className="hidden lg:block h-px bg-[#DDDCF9]"></div>
    ...
    <div className="flex flex-col items-center gap-3 py-2 text-center">
        ...
        Deactivating your account means you will lose access to all your data and
        history within our platform. Please take a moment to consider the
