...
const [joinedGroups,   setJoinedGroups]   = useState([OTHER_GROUPS[0]]);
...
setMyGroups((prev) => [
     ...prev,
     {
     id: Date.now(), name: form.name, avatar: "/groupchatprofilepic.png",
     participants: 1, members: 1, mentors: 0,
     time: "", description: form.description, messages: [],
     },
]);
};
...
<>
     ...
     {/* ════ LEFT PANEL ════ */}
     <div className={`flex flex-col w-full lg:w-72 shrink-0 border-r border-slate-100
          ...
          <div className="flex-1 overflow-y-auto min-h-0">
               ...
               return (
               <button key={mentor.id} onClick={() => setSelectedMentor(mentor)}
