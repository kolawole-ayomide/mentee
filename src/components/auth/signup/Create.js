...
// ── Designation options mapped per department ──
...
export default function CreatePage() {
  ...
  // ── when department changes, reset designation since options change ──
  const handleDepartmentChange = (e) => {
    setDepartment(e.target.value);
    setDesignation(""); // reset so user picks a valid designation for the new department
  };

  const handleNextSubmit = (e) => {
    e.preventDefault();

    if (!firstName || !lastName || !workEmail || !staffId || !department || !designation) {
  ...
  // ── get designation list for the selected department ──
  const designationOptions = DESIGNATIONS_BY_DEPARTMENT[department] || [];
      ...
      <div className="w-full lg:w-[58%] flex flex-col justify-between relative bg-white min-h-screen lg:min-h-0">
        ...
        <div className="max-w-xl w-full mx-auto px-6 sm:px-12 lg:px-16 py-12 my-auto space-y-6">
          ...
          <form onSubmit={handleNextSubmit} className="space-y-4">
            ...
            <div className="space-y-1 text-left">
              ...
              <div className="relative">
                ...
                >
                  ...
                  {Object.keys(DESIGNATIONS_BY_DEPARTMENT).map((dept) => (
            ...
            {/* Designation — options depend on selected Department */}
            <div className="space-y-1 text-left">
              <label className="text-[11px] font-bold text-gray-700 block">
              ...
              <div className="relative">
                <select
                  ...
                  disabled={!department}
                  className="w-full text-xs p-3 border border-gray-200 rounded-lg focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400 bg-white text-gray-900 appearance-none cursor-pointer disabled:bg-gray-50 disabled:cursor-not-allowed"
                  required
                >
                  <option value="" disabled hidden>
                    {department ? "Select your designation" : "Select a department first"}
                  </option>
